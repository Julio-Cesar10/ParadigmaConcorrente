...
executar ao mesmo tempo, característica fundamental do paradigma
concorrente.
...
De onde surgiu a necessidade da conta conjunta
Cenário usado
Porque o nosso projeto ajuda nisso
Como o programa funciona;
Dinâmica das classes
Métodos usados
Atributos usados
FAZER UML
Onde ocorre a concorrência no programa;
Explicação do método run
Explicação do start
Explicação do synchronized
Explicação do sleep.
Demonstração do programa executando.   
Executar programa, mostrar como ele funciona.
